...
#include "BluetoothSerial.h" //C.R

#define READ_PIN 0
#define BUTTON_PIN D1

#define NUMBER_OF_CLIENTS 1 // Changed as I have one tower being supported by the other


/* CR. Notes on what to do:
 *  Need to have it set up a bluetooth connection with my phone to read analog music data
 *  Then hook up to other towers with wifi connection
 *  As the master tower it will need to both transmit and display the led show!
 *
 *
 */
...
// C.R. remove the code related to button press to switch styles.
